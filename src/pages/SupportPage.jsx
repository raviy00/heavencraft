    ...
    return (
        <div className="w-full max-w-4xl mx-auto rounded-xl p-8 shadow-2xl backdrop-blur-3xl bg-black/40 border border-white/10" style={{ animation: 'fadeIn 0.3s ease-out' }}>
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <a href="https://discord.gg/sFVSwW3v" target="_blank" rel="noopener noreferrer" className="p-6 rounded-lg bg-white/5 border border-white/10 hover:border-primary transition-colors cursor-pointer flex flex-col items-center text-center">
                ...
                <a href="https://discord.gg/x5PXUU9S" target="_blank" rel="noopener noreferrer" className="p-6 rounded-lg bg-white/5 border border-white/10 hover:border-primary transition-colors cursor-pointer flex flex-col items-center text-center">
                    <span className="material-symbols-outlined text-4xl text-emerald-400 mb-3">book</span>
                    <h3 className="font-bold text-lg mb-2 text-white">Wiki & Guides</h3>
